...
class PanModalViewController: UITableViewController {
...
extension PanModalViewController {
...
private extension PanModalViewController {
    ...
    enum RowType: Int, CaseIterable {
        ...
        struct FullScreen: RowPresentable {
            ...
            let rowVC: PanModalPresentable.LayoutType = FullScreenNavViewController()
        }
